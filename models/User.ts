...
type UserAssociations = 'transactions' | 'beneficiaryTransactions' | 'verificationTokens' | 'walletBalances'
...
> {
  ...
  declare idDocType: 'national_id' | 'drivers_license' | 'international_passport' | null
  ...
  declare setBeneficiaryTransactions: HasManySetAssociationsMixin<Transaction, number>
  declare addBeneficiaryTransaction: HasManyAddAssociationMixin<Transaction, number>
  declare addBeneficiaryTransactions: HasManyAddAssociationsMixin<Transaction, number>
  declare createBeneficiaryTransaction: HasManyCreateAssociationMixin<Transaction>
  declare removeBeneficiaryTransaction: HasManyRemoveAssociationMixin<Transaction, number>
  declare removeBeneficiaryTransactions: HasManyRemoveAssociationsMixin<Transaction, number>
  declare hasBeneficiaryTransaction: HasManyHasAssociationMixin<Transaction, number>
  declare hasBeneficiaryTransactions: HasManyHasAssociationsMixin<Transaction, number>
  ...
  declare setVerificationTokens: HasManySetAssociationsMixin<VerificationToken, number>
  declare addVerificationToken: HasManyAddAssociationMixin<VerificationToken, number>
  declare addVerificationTokens: HasManyAddAssociationsMixin<VerificationToken, number>
  declare createVerificationToken: HasManyCreateAssociationMixin<VerificationToken>
  declare removeVerificationToken: HasManyRemoveAssociationMixin<VerificationToken, number>
  declare removeVerificationTokens: HasManyRemoveAssociationsMixin<VerificationToken, number>
  declare hasVerificationToken: HasManyHasAssociationMixin<VerificationToken, number>
  declare hasVerificationTokens: HasManyHasAssociationsMixin<VerificationToken, number>
  ...
  declare removeWalletBalance: HasManyRemoveAssociationMixin<WalletBalance, number>
  declare removeWalletBalances: HasManyRemoveAssociationsMixin<WalletBalance, number>
